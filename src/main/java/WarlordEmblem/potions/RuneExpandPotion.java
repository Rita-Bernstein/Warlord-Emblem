 ...
 public class RuneExpandPotion extends AbstractPotion {
     public static final String POTION_ID = WarlordEmblem.makeID("RuneExpandPotion");
     ...
     private static final PotionColor PotionColor =  AbstractPotion.PotionColor.BLUE;

 
   
   public RuneExpandPotion() {
   ...
   public AbstractPotion makeCopy() { return new RuneExpandPotion(); }
 }
