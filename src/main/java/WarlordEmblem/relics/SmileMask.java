...
public class SmileMask extends CustomRelic {
   ...
   public SmileMask() { super(WarlordEmblem.makeID("SmileMask"),new Texture(WarlordEmblem.assetPath("/img/relics/smile_mask.png")) , RelicTier.COMMON, CustomRelic.LandingSound.FLAT); }
