...
public class VoidPower extends CustomRelic {
   ...
   public VoidPower() { super(WarlordEmblem.makeID("VoidPower"),new Texture(WarlordEmblem.assetPath("/img/relics/void_power.png")) , RelicTier.BOSS, CustomRelic.LandingSound.FLAT); }
   ...
   public void atBattleStart() {
       ...
       AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(new Dazed(), 5, true, true, false, Settings.WIDTH * 0.2F, Settings.HEIGHT / 2.0F));
