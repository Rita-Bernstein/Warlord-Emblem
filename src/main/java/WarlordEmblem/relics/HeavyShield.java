...
public class HeavyShield extends CustomRelic {
   ...
   public HeavyShield() { super(WarlordEmblem.makeID("HeavyShield"),new Texture(WarlordEmblem.assetPath("/img/relics/heavy_shield.png")) , RelicTier.BOSS, CustomRelic.LandingSound.FLAT); }
