...
public class BrokenMantle extends CustomRelic {
   ...
   public BrokenMantle() { super(WarlordEmblem.makeID("BrokenMantle"),new Texture(WarlordEmblem.assetPath("/img/relics/broken_mantle.png")) , RelicTier.UNCOMMON, CustomRelic.LandingSound.FLAT); }
