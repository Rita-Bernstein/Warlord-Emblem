...
public class KitchenKnife extends CustomRelic {
   ...
   public KitchenKnife() { super(WarlordEmblem.makeID("KitchenKnife"),new Texture(WarlordEmblem.assetPath("/img/relics/kitchen_knife.png")) , RelicTier.UNCOMMON, CustomRelic.LandingSound.FLAT); }
