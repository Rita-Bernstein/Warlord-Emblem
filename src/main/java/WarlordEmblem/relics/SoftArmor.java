...
public class SoftArmor extends CustomRelic {
   ...
   public SoftArmor() { super(WarlordEmblem.makeID("SoftArmor"),new Texture(WarlordEmblem.assetPath("/img/relics/soft_armor.png")) , RelicTier.RARE, CustomRelic.LandingSound.FLAT); }
