...
public class EvilBlood extends CustomRelic {
   ...
   public EvilBlood() { super(WarlordEmblem.makeID("EvilBlood"),new Texture(WarlordEmblem.assetPath("/img/relics/evil_blood.png")) , RelicTier.RARE, CustomRelic.LandingSound.FLAT); }
