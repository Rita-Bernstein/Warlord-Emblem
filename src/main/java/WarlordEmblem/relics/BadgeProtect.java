...
public class BadgeProtect extends CustomRelic {
   ...
   public BadgeProtect() { super(WarlordEmblem.makeID("BadgeProtect"),new Texture(WarlordEmblem.assetPath("/img/relics/badge_protect.png")) , RelicTier.BOSS, CustomRelic.LandingSound.FLAT); }
