...
public class GoldMime extends CustomRelic {
   ...
   public GoldMime() { super(WarlordEmblem.makeID("GoldMime"),new Texture(WarlordEmblem.assetPath("/img/relics/goldmime.png")) , RelicTier.UNCOMMON, CustomRelic.LandingSound.FLAT); }
