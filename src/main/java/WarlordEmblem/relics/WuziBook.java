...
public class WuziBook extends CustomRelic {
   ...
   public WuziBook() { super(WarlordEmblem.makeID("WuziBook"),new Texture(WarlordEmblem.assetPath("/img/relics/wuzi_book.png")) , RelicTier.COMMON, CustomRelic.LandingSound.FLAT); }
