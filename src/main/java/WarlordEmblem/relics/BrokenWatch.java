...
public class BrokenWatch extends CustomRelic {
   ...
   public BrokenWatch() { super(WarlordEmblem.makeID("BrokenWatch"),new Texture(WarlordEmblem.assetPath("/img/relics/broken_watch.png")) , RelicTier.RARE, CustomRelic.LandingSound.FLAT); }
