...
public class QuestCardWarriorReward extends AbstractQuestCard {
    public static final String ID = WarlordEmblem.makeID("QuestCardWarriorReward");
    ...
    public AbstractCard makeCopy() {
        return new QuestCardWarriorReward();
    }
